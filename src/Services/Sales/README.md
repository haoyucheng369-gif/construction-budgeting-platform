...
This implements the inward dependency rule of Clean Architecture and the ports/adapters boundary of Hexagonal Architecture. DDD models will be implemented inside Domain; these are not separate framework installations.
